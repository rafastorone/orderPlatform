...
- pplication.yml is used when the service runs from the IDE. It connects to PostgreSQL at localhost:5435, Kafka at localhost:29092, and Redis at localhost:6379.
