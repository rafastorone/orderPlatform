...
- Docker Compose loads .env into the application and PostgreSQL containers. In the example file, the Docker values point to checkout-service-postgres:5432, kafka:9092, and redis:6379 through orderflow-network.
