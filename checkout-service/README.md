...
- src/main/resources/application.yml is used when the service runs from the IDE. It connects to PostgreSQL at localhost:5434, Kafka at localhost:29092, and Redis at localhost:6379.
- src/main/resources/application-docker.yml is the container profile. It connects through orderflow-network to checkout-service-postgres:5432, kafka:9092, and redis:6379.
