...
- src/main/resources/application.yml reads environment variables and provides local IDE defaults: PostgreSQL at localhost:5433, Kafka at localhost:29092, and Redis at localhost:6379.
- Docker Compose loads .env into the application and PostgreSQL containers. In the example file, the Docker values point to catalog-service-postgres:5432, kafka:9092, and redis:6379 through orderplatform-network.
