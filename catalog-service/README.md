...
- Docker Compose loads .env into the application and PostgreSQL containers. In the example file, the Docker values point to catalog-service-postgres:5432, kafka:9092, and redis:6379 through orderflow-network.
